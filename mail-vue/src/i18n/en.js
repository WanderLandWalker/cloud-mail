const en = {
    ...
    editTelegramBot: 'Edit Telegram Bot',
    telegramBotName: 'Bot name',
    telegramAccounts: 'email address(es)',
    telegramChats: 'Chat ID(s)',
    noTelegramBots: 'No Telegram bots configured',
    deleteTelegramBotConfirm: 'Delete Telegram bot {msg}? The linked email addresses will not be deleted.',
    edit: 'Edit',
    disable: 'Disable',
    disabled: 'Disabled',
    ...
    tgBotDesc: 'Bind multiple email addresses and Chat IDs to each bot, then choose received, sent, or both emails',
    tgBotToken: 'Bot token',
    toBotTokenDesc: 'Multiple user chat_ids, separated by commas',
    telegramRouteType: 'Forward source',
    telegramRouteReceive: 'Received mail (Recommended)',
    telegramRouteSend: 'Sent mail',
    telegramRouteBoth: 'Received and sent mail',
    ...
    restoreAccountConfirm: 'Restore {msg}? Existing emails will be kept.',
    recreateAccountConfirm: 'Recreate {msg}? The old mailbox will be restored and existing emails will be kept.',
    promoteAccountConfirm: 'Promote {msg} to an independent user? Existing emails will be kept. Set a new password.',
    promoteAccount: 'Promote to User',
    recreateSuccessMsg: 'Email address recreated successfully',
