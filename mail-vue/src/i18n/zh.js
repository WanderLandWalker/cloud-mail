const zh = {
    ...
    editTelegramBot: '编辑 Telegram 机器人',
    telegramBotName: '机器人名称',
    telegramAccounts: '个邮箱',
    telegramChats: '个 Chat ID',
    noTelegramBots: '还没有配置 Telegram 机器人',
    deleteTelegramBotConfirm: '确认删除 Telegram 机器人 {msg} 吗？关联邮箱不会被删除。',
    edit: '编辑',
    disable: '关闭',
    disabled: '已关闭',
    otherEmail: '第三方邮箱',
    ...
    tgBotDesc: '每个机器人可以绑定多个邮箱和 Chat ID，并选择按接收、发送或收发邮件转发',
    tgBotToken: '机器人 token',
    toBotTokenDesc: '用户 chat_id 多个用,分开',
    telegramRouteType: '转发来源',
    telegramRouteReceive: '接收邮箱（推荐）',
    telegramRouteSend: '发送邮箱',
    telegramRouteBoth: '收发邮箱',
    ...
    restoreAccountConfirm: '确认恢复 {msg} 吗？邮件不会被清空。',
    recreateAccountConfirm: '确认重新创建 {msg} 吗？系统会恢复原邮箱，邮件不会被清空。',
    promoteAccountConfirm: '确认将 {msg} 转为独立用户吗？原邮件会保留，请设置新密码。',
    promoteAccount: '转为独立用户',
    recreateSuccessMsg: '邮箱已重新创建',
    normalRestore: '普通恢复',
    allRestore: '包括已删除的数据',
