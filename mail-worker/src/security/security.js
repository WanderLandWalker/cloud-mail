...
const premKey = {
	...
	'account:add': ['/account/add', '/account/recreate'],
	...
	'user:add': ['/user/add', '/user/promoteAccount'],
	'user:reset-send': ['/user/resetSendCount'],
	'user:set-pwd': ['/user/setPwd'],
	'user:set-status': ['/user/setStatus', '/user/restore', '/user/restoreAccount'],
	'user:set-type': ['/user/setType'],
	'user:delete': ['/user/delete','/user/deleteAccount', '/user/recreateAccount'],
	'all-email:query': ['/allEmail/list','/allEmail/latest'],
	'all-email:delete': ['/allEmail/delete','/allEmail/batchDelete'],
	'setting:query': ['/setting/query', '/telegram/bot/list', '/telegram/bot/accounts'],
	'setting:set': ['/setting/set', '/setting/setBackground','/setting/deleteBackground','/setting/setBlacklist', '/telegram/bot/save', '/telegram/bot/delete'],
