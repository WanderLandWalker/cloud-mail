const zh = {
	...
	notExistAccount: '邮箱不存在',
	accountNotDeleted: '该邮箱未被删除，不能重新创建',
	mainAccountActionDenied: '不能对用户主邮箱执行此操作',
	accountAlreadyUser: '该邮箱已经是独立用户',
	telegramBotNotExist: 'Telegram 机器人不存在',
	telegramBotTokenRequired: '请输入 Telegram 机器人 token',
	telegramChatIdRequired: '请至少输入一个 Telegram Chat ID',
